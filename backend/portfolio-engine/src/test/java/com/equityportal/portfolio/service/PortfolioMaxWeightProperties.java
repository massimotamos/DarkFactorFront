...
// Feature: equity-trading-portal, Property 15: No single allocation exceeds 40%
class PortfolioMaxWeightProperties {
    ...
    @Property(tries = 100)
    void noSingleAllocationExceeds40Percent(
        ...
        for (AllocationLine line : rec.getAllocations()) {
            assertThat(line.getWeightPercent())
                    .as("No single allocation weight should exceed 40.00%")
