...
class PortfolioWeightSumProperties {
    ...
    @Property(tries = 100)
    void allocationWeightsSumTo100(
        ...
        assertThat(sum.subtract(new BigDecimal("100.00")).abs())
                .as("Sum of weights must equal 100.00 (within 0.01 tolerance)")
